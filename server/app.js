(() => {
    ...
    if (!require("glob").sync('./config/env/' + process.env.NODE_ENV + '.js').length)
        return console.log('No configuration file found for "' + process.env.NODE_ENV + '" environment! Aborting startup...');
